...
WidgetCall::WidgetCall(QWidget *parent) :
    QWidget(parent)
{
    ...
    //dest_01->setStyleSheet("background-color: red;border-style: outset;border-width: 2px;border-radius: 20px;border-color: beige;font: bold 14px;min-width: 10em;padding: 6px;");
